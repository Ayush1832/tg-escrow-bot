...
async function deployUSDTBSC10() {
  try {
    const {
      MONGODB_URI,
      USDT_BSC,
    ...
    if (!USDT_BSC) throw new Error('USDT_BSC token address missing');
    ...
    console.log(`🚀 Deploying ${deployCount} USDT-BSC contracts with ${feePercent}% fee...`);
